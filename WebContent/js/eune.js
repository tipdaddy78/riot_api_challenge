    ...
    request.onload = function() {
      ...
      if (request.status >= 200 && request.status < 400){
        ...
        for(i = 0; i < items.length; i++) {
            ...
            rankedPickData511[i] = ((data.patches[1].queues[0].regions[4].items[i].stats[4].pick_rate)*100).toFixed(2);
            rankedPickData514[i] = ((data.patches[0].queues[0].regions[4].items[i].stats[4].pick_rate)*100).toFixed(2);
            rankedWinData511[i] = ((data.patches[1].queues[0].regions[4].items[i].stats[4].win_rate)*100).toFixed(2);
            rankedWinData514[i] = ((data.patches[0].queues[0].regions[4].items[i].stats[4].win_rate)*100).toFixed(2);
            normalPickData511[i] = ((data.patches[1].queues[1].regions[4].items[i].stats[4].pick_rate)*100).toFixed(2);
            normalPickData514[i] = ((data.patches[0].queues[1].regions[4].items[i].stats[4].pick_rate)*100).toFixed(2);
            normalWinData511[i] = ((data.patches[1].queues[1].regions[4].items[i].stats[4].win_rate)*100).toFixed(2);
            normalWinData514[i] = ((data.patches[0].queues[1].regions[4].items[i].stats[4].win_rate)*100).toFixed(2);
        }
        ...
        if(selLane == "" && selChampion != "") { // Lane not specified, Champion IS specified
            ...
            var index = 5;
            for(i = 0; i < 126; i++) {
                if (selChampion == data.patches[0].queues[0].regions[4].items[selItem].stats[index].champion){
                    for(j = index; j < (index+4); j++){
                        champName = data.patches[0].queues[0].regions[4].items[selItem].stats[j].champion;
                        champLane = data.patches[0].queues[0].regions[4].items[selItem].stats[j].lane; 
                        rankedChampPick511 = ((data.patches[1].queues[0].regions[4].items[selItem].stats[j].pick_rate)*100).toFixed(2);
                        rankedChampPick514 = ((data.patches[0].queues[0].regions[4].items[selItem].stats[j].pick_rate)*100).toFixed(2);
                        rankedChampWin511 = ((data.patches[1].queues[0].regions[4].items[selItem].stats[j].win_rate)*100).toFixed(2);
                        rankedChampWin514 = ((data.patches[0].queues[0].regions[4].items[selItem].stats[j].win_rate)*100).toFixed(2);
                        normalChampPick511 = ((data.patches[1].queues[1].regions[4].items[selItem].stats[j].pick_rate)*100).toFixed(2);
                        normalChampPick514 = ((data.patches[0].queues[1].regions[4].items[selItem].stats[j].pick_rate)*100).toFixed(2);
                        normalChampWin511 = ((data.patches[1].queues[1].regions[4].items[selItem].stats[j].win_rate)*100).toFixed(2);
                        normalChampWin514 = ((data.patches[0].queues[1].regions[4].items[selItem].stats[j].win_rate)*100).toFixed(2);
            ...
            for(i = 0; i < 126; i++) {
                champName = data.patches[0].queues[0].regions[4].items[selItem].stats[index].champion;
                champLane = data.patches[0].queues[0].regions[4].items[selItem].stats[index].lane; 
                rankedChampPick511 = ((data.patches[1].queues[0].regions[4].items[selItem].stats[index].pick_rate)*100).toFixed(2);
                rankedChampPick514 = ((data.patches[0].queues[0].regions[4].items[selItem].stats[index].pick_rate)*100).toFixed(2);
                rankedChampWin511 = ((data.patches[1].queues[0].regions[4].items[selItem].stats[index].win_rate)*100).toFixed(2);
                rankedChampWin514 = ((data.patches[0].queues[0].regions[4].items[selItem].stats[index].win_rate)*100).toFixed(2);
                normalChampPick511 = ((data.patches[1].queues[1].regions[4].items[selItem].stats[index].pick_rate)*100).toFixed(2);
                normalChampPick514 = ((data.patches[0].queues[1].regions[4].items[selItem].stats[index].pick_rate)*100).toFixed(2);
                normalChampWin511 = ((data.patches[1].queues[1].regions[4].items[selItem].stats[index].win_rate)*100).toFixed(2);
                normalChampWin514 = ((data.patches[0].queues[1].regions[4].items[selItem].stats[index].win_rate)*100).toFixed(2);
