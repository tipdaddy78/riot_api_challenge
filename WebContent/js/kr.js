            ...
            for(i = 0; i < 126; i++) {
                if (selChampion == data.patches[0].queues[0].regions[2].items[selItem].stats[index].champion){
                    for(j = index; j < (index+4); j++){
                        ...
                        rankedChampPick511 = ((data.patches[1].queues[0].regions[2].items[selItem].stats[j].pick_rate)*100).toFixed(2);
                        rankedChampPick514 = ((data.patches[0].queues[0].regions[2].items[selItem].stats[j].pick_rate)*100).toFixed(2);
                        rankedChampWin511 = ((data.patches[1].queues[0].regions[2].items[selItem].stats[j].win_rate)*100).toFixed(2);
                        rankedChampWin514 = ((data.patches[0].queues[0].regions[2].items[selItem].stats[j].win_rate)*100).toFixed(2);
                        normalChampPick511 = ((data.patches[1].queues[1].regions[2].items[selItem].stats[j].pick_rate)*100).toFixed(2);
                        normalChampPick514 = ((data.patches[0].queues[1].regions[2].items[selItem].stats[j].pick_rate)*100).toFixed(2);
