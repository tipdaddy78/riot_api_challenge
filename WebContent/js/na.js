      ...
      if (request.status >= 200 && request.status < 400){
       ...
       var fullTable = document.getElementById("table").createCaption();
        ...
        if(selLane == "" && selChampion != "") { // Lane not specified, Champion IS specified
            ...
            var index = 5;
            for(i = 0; i < 126; i++) {
                if (selChampion == data.patches[0].queues[0].regions[1].items[selItem].stats[index].champion){
                    for(j = index; j < (index+4); j++){
                        champName = data.patches[0].queues[0].regions[1].items[selItem].stats[j].champion;
                        champLane = data.patches[0].queues[0].regions[1].items[selItem].stats[j].lane; 
                        rankedChampPick511 = ((data.patches[1].queues[0].regions[1].items[selItem].stats[j].pick_rate)*100);
                        rankedChampPick514 = ((data.patches[0].queues[0].regions[1].items[selItem].stats[j].pick_rate)*100);
                        rankedChampWin511 = ((data.patches[1].queues[0].regions[1].items[selItem].stats[j].win_rate)*100);
                        rankedChampWin514 = ((data.patches[0].queues[0].regions[1].items[selItem].stats[j].win_rate)*100);
                        normalChampPick511 = ((data.patches[1].queues[1].regions[1].items[selItem].stats[j].pick_rate)*100);
                        normalChampPick514 = ((data.patches[0].queues[1].regions[1].items[selItem].stats[j].pick_rate)*100);
                        normalChampWin511 = ((data.patches[1].queues[1].regions[1].items[selItem].stats[j].win_rate)*100);
                        normalChampWin514 = ((data.patches[0].queues[1].regions[1].items[selItem].stats[j].win_rate)*100);
            ...
            for(i = 0; i < 126; i++) {
                champName = data.patches[0].queues[0].regions[1].items[selItem].stats[index].champion;
                champLane = data.patches[0].queues[0].regions[1].items[selItem].stats[index].lane; 
                rankedChampPick511 = ((data.patches[1].queues[0].regions[1].items[selItem].stats[index].pick_rate)*100);
                rankedChampPick514 = ((data.patches[0].queues[0].regions[1].items[selItem].stats[index].pick_rate)*100);
                rankedChampWin511 = ((data.patches[1].queues[0].regions[1].items[selItem].stats[index].win_rate)*100);
                rankedChampWin514 = ((data.patches[0].queues[0].regions[1].items[selItem].stats[index].win_rate)*100);
                normalChampPick511 = ((data.patches[1].queues[1].regions[1].items[selItem].stats[index].pick_rate)*100);
                normalChampPick514 = ((data.patches[0].queues[1].regions[1].items[selItem].stats[index].pick_rate)*100);
                normalChampWin511 = ((data.patches[1].queues[1].regions[1].items[selItem].stats[index].win_rate)*100);
                normalChampWin514 = ((data.patches[0].queues[1].regions[1].items[selItem].stats[index].win_rate)*100);
        ...
        var rankedPick = {labels: items,
            datasets: [
                ...
                {
                    label: "5.14 Patch",
                    fillColor: "rgba(93,118,49,0.5)",
                    strokeColor: "rgba(93,118,49,1)",
                    highlightFill: "rgba(93,118,49,0.75)",
                    highlightStroke: "rgba(93,118,49,1)",
